...
if __name__=="__main__":
    ...
    # create_table5.create_title("12","23")
    ...
    text5=create_table5.get_all_title()
    ...
    # create_table5.update_title("12",title="天天向上")

    # create_table1.delete_chat("3508c7c7-fced-11ef-9c56-f077c346fabd")
    create_table5.delete_title("12")
